  ...
  run: async (client, message, args) => {
    const row = new ActionRowBuilder().addComponents(
      ...
      new ButtonBuilder()
        .setLabel("Elo server")
        .setStyle(ButtonStyle.Link)
        .setURL("https://discord.gg/Fb8RpXpX"),
      new ButtonBuilder()
        .setLabel("Youtube")
        .setStyle(ButtonStyle.Link)
...
To see decks with a specific hero do <@1043528908148052089> helpherointials`,
        ...
        {
          name: "elo",
          value: `Tbot does have an elo system set up which is used for competing against other pvzh players but can only be done in the elo server 
Check out the elo server button below to join!`,
        },
        {
          name: "Developer",
...
You can also subscribe to his Youtube channel below where tbone uploads gaming and other videos.`,
        ...
        },
        {
          ...
          value: `Tbot has ${client.commands.size} commands and is in ${client.guilds.cache.size} servers 
Along with ${commands.length} decklists stored in the database`,
        },
        {
          name: "Donate",
