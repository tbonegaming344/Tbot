...
module.exports = {
	...
	run: async(client, message, args)=> {
		...
		.addFields({name: "Stats",
							 ...
							 {
								 name: "Ability",
								 value: "__Conjure__ a Plant that costs 2<:Sun:1062501177679413409>. It gets +1<:Strength:1062501774612779039>/+1<:Health:1062515540712751184>, __Amphibious__, and __Team-Up__."
							 },
							 {
								 name: "Set-Rarity",
