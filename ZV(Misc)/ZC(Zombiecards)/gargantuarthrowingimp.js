...
module.exports = {
	...
	run: async(client, message, args) => {
			...
			.addFields({name: "Stats", 
								 ...
								 {
									name: "Ability", 
									 value: "**When hurt:** Make a random Gargantuar that costs 5<:Brainz:1062503146745774183> in a random lane." 
								 },
								 {
									name:  "Set-Rarity", 
									 value: "**Event**"
								 ...
								 {
									 name: "Flavor Text", 
									 value: "When lifting a Gargantuar, always bend at the knees. He learned this the hard way."
								 })
			.setColor("Random")			
