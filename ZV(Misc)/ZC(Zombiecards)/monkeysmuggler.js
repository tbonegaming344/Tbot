...
module.exports = {
	...
	run: async(client, message, args) => {
		let embed = new EmbedBuilder()
			.setTbumbnail("https://static.wikia.nocookie.net/plantsvszombies/images/c/c2/Monkey_Smuggler.png/revision/latest/scale-to-width-down/250?cb=20200919153229")
