...
module.exports = {
	...
	aliases: [`cc6`, `jaintor`, `spacejanitor`, `mop`, `custodian`, `celestial`],
	...
	run: async(client, message, args) => {
			...
			.addFields({name: "Stats", value: "3 <:Strength:1062501774612779039>, 2 <:Health:1062515540712751184>, 3 <:Brainz:1062503146745774183>"},
								 {
									 name: "Ability",  
									 value: "**When played in an Environment**: Destroy a Plant with 2<:Strength:1062501774612779039> or less."
								 },
								 {
									 name: "Set-Rarity", 
