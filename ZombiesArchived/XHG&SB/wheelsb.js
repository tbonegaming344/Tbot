...
module.exports = {
	name: `wheelsb`,
	aliases: [`sbwheel`, `wheelbrainz`, `wheelsuperbrainz`],
	category: `Huge-Gigantacus/SuperBrainz`,
	run: async(client, message, args)=> {
		if(!args[0]){
			return message.reply("Please input a number format wheelsb number")
		}
		if(isNaN(args[0])) {
	...
	embed.setDescription(`Here is your wheel for Super Brainz
 **${randomWords.join('\n')}**`)
		.setColor("Random")
