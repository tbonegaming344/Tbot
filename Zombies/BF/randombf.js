...
module.exports = {
	name: `randombf`, 
	aliases: [`bfrandom`, `randombfdeck`, `bfrandomdeck`, `randomizeddeckbf`, `bfrandomizeddeck`, `brainfreezerandom`, `randombrainfreeze`, `rbf`],
	category: `Brain Freeze(BF)`,
	run: async(client, message, args) => {
		let [result] = await db.query(`SELECT * FROM bfdecks where deckinfo = 'image link:'`)
		const deck = [
//BF TBOT DB 
...
//BF WEB DB
	...
	.setDescription(`Here is your random Brain Freeze(BF) Deck ${message.author}`)
		.setColor("Random")
