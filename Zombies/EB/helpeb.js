...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    //Bunnary 22
    const bu22 = new ActionRowBuilder().addComponents(
      new ButtonBuilder()
        .setCustomId("bburn")
        .setLabel("🔙")
        .setStyle(ButtonStyle.Primary),
    ...
    //Seacret
    const sf = new ActionRowBuilder().addComponents(
      new ButtonBuilder()
        .setCustomId("prem")
        .setLabel("🔙")
        .setStyle(ButtonStyle.Primary),
    ...
    let embed = new EmbedBuilder()
      ...
      .setDescription(
        `My commands for Electric Boogaloo(EB) are ${toBuildString}`
      )
      .setFooter({
        text: `To view the Electric Boogaloo decks please use the commands listed above or click on the buttons below!
