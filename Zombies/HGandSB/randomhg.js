...
module.exports = {
	name: `randomhg`,
	aliases: [`hgrandom`, `hgrandomizeddeck`, `randomizeddeckhg`, `hugegigantacusrandom`, `randomhugegigantacus`, `randomizeddeckhugegigantacus`, `hugegigantacusrandomizeddeck`, `rhg`],
	category: `Huge-Gigantacus/SuperBrainz`,
	run: async(client, message, args) => {
		let [result] = await db.query(`SELECT * FROM hgdecks where deckinfo = 'image link:'`); 
		const deck = 			[
	//HG TBOT DB
...
//HG WEB DB
	...
	.setDescription(`Here is your random Huge-Gigantacus(HG) Deck ${message.author}`)
		.setColor("Random")
